...
const CEFR_LEVELS = {
   ...
   A1: [
    ...
    { spanish: "minutos", english: "minutes" },
    ...
    { spanish: "amiga", english: "friend (female)" },

    // Missing adjectives
    { spanish: "nuevo", english: "new" },
    { spanish: "nueva", english: "new (fem.)" },
    { spanish: "nuevos", english: "new (plural)" },
    { spanish: "lentamente", english: "slowly" },
    { spanish: "afuera", english: "outside" },
...
B1: [
    ...
    { spanish: "has", english: "you have (auxiliary)" },
    ...
    { spanish: "documentos", english: "documents" },
    { spanish: "proyecto", english: "project" },
    { spanish: "situación", english: "situation" },
    { spanish: "informe", english: "report" },
    { spanish: "metas", english: "goals" },
    { spanish: "mes", english: "month" },
    { spanish: "equipo", english: "team" },
    { spanish: "detalles", english: "details" },

    // Missing B1 adjectives
    ...
    // Missing B1 determiners
    { spanish: "nuestras", english: "our (fem. plural)" },
    { spanish: "este", english: "this (masc.)" },
    { spanish: "esto", english: "this (neutral)" },
   ...
   B2: [
    ...
    { spanish: "ampliar", english: "to expand" },
    { spanish: "adaptarse", english: "to adapt" },
    { spanish: "reducir", english: "to reduce" },
    { spanish: "insistir", english: "to insist" },
    { spanish: "explorar", english: "to explore" },
    { spanish: "aclarar", english: "to clarify" },
    { spanish: "parecer", english: "to seem" },
    { spanish: "fortalecer", english: "to strengthen" },
    { spanish: "discutir", english: "to discuss" },
    { spanish: "actualizar", english: "to update" },
    { spanish: "aumentar", english: "to increase" },
    { spanish: "prepararse", english: "to prepare oneself" },
    { spanish: "expandir", english: "to expand" },
    { spanish: "coordinar", english: "to coordinate" },
    { spanish: "optimizar", english: "to optimize" },

    // Missing B2 nouns
    { spanish: "posibilidades", english: "possibilities" },
    { spanish: "proceso", english: "process" },
    { spanish: "tarea", english: "task" },
    { spanish: "riesgos", english: "risks" },
    { spanish: "plan", english: "plan" },
    { spanish: "resultados", english: "results" },
    { spanish: "experiencia", english: "experience" },
    { spanish: "concepto", english: "concept" },
    { spanish: "manera", english: "way/manner" },
    { spanish: "problemas", english: "problems" },
    { spanish: "idea", english: "idea" },
    { spanish: "gastos", english: "expenses" },
    { spanish: "datos", english: "data" },
    { spanish: "rendimiento", english: "performance" },
    { spanish: "tema", english: "topic" },
    { spanish: "enfoque", english: "approach" },
    { spanish: "sistema", english: "system" },
    { spanish: "estrategia", english: "strategy" },
    { spanish: "negocio", english: "business" },
    { spanish: "flujo", english: "flow" },
    { spanish: "esfuerzos", english: "efforts" },

    // Missing B2 adjectives
    ...
    { spanish: "clara", english: "clear (fem.)" },
    { spanish: "innovadora", english: "innovative" },
    { spanish: "innecesarios", english: "unnecessary" },
    { spanish: "complicado", english: "complicated" },
    { spanish: "necesario", english: "necessary" },
    { spanish: "capaz", english: "capable" },
    { spanish: "efectivo", english: "effective" },
    { spanish: "posible", english: "possible" },

    // Missing B2 determiners
    { spanish: "todas", english: "all (fem. plural)" },
    { spanish: "este", english: "this (masc.)" },
    { spanish: "esta", english: "this (fem.)" },
    { spanish: "mejores", english: "better (plural)" },

    // Missing B2 connectors
    { spanish: "aunque", english: "although" },
    { spanish: "cuidadosamente", english: "carefully" },
    { spanish: "incluso", english: "even" },
    { spanish: "otra vez", english: "again" },
