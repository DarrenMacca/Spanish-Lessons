...
/* ============================================================
 ...
 const CEFR_PHRASES_A1 = [
  ...
  { english: "my name is", spanish: "me llamo", level: "A1" },
  { english: "where are you from", spanish: "de dónde eres", level: "A1" },
  { english: "i am from australia", spanish: "soy de australia", level: "A1" },
  { english: "i don't understand", spanish: "no entiendo", level: "A1" },
  { english: "can you repeat", spanish: "puedes repetir", level: "A1" },
  ...
  { english: "i am learning spanish", spanish: "estoy aprendiendo español", level: "A1" },
  ...
  { english: "see you tomorrow", spanish: "hasta mañana", level: "A1" },
  { english: "excuse me", spanish: "perdón", level: "A1" },
  { english: "i am sorry", spanish: "lo siento", level: "A1" },
  { english: "thank you very much", spanish: "muchas gracias", level: "A1" },
  { english: "you are welcome", spanish: "de nada", level: "A1" },
  { english: "i am fine", spanish: "estoy bien", level: "A1" },
  { english: "i am not well", spanish: "no estoy bien", level: "A1" },
  ...
  { english: "i like it", spanish: "me gusta", level: "A1" },
  { english: "i don't like it", spanish: "no me gusta", level: "A1" },
  { english: "what is this", spanish: "qué es esto", level: "A1" },
  { english: "what does this mean", spanish: "qué significa esto", level: "A1" },
  { english: "where is it", spanish: "dónde está", level: "A1" },
  { english: "what do you want", spanish: "qué quieres", level: "A1" },
  { english: "i want this", spanish: "quiero esto", level: "A1" },
  { english: "i want that", spanish: "quiero eso", level: "A1" },
  { english: "can you help me", spanish: "puedes ayudarme", level: "A1" },
  { english: "i am busy", spanish: "estoy ocupado", level: "A1" },
  { english: "i am ready", spanish: "estoy listo", level: "A1" },
  { english: "wait a moment", spanish: "espera un momento", level: "A1" },
  { english: "come here", spanish: "ven aquí", level: "A1" },
  { english: "go there", spanish: "ve allí", level: "A1" },
  { english: "i am coming", spanish: "ya voy", level: "A1" },
  { english: "i am going", spanish: "me voy", level: "A1" },
  { english: "what happened", spanish: "qué pasó", level: "A1" },
  { english: "i don't know", spanish: "no sé", level: "A1" },
  { english: "i know", spanish: "sé", level: "A1" },
  { english: "i remember", spanish: "recuerdo", level: "A1" },
  { english: "i forgot", spanish: "olvidé", level: "A1" },
  { english: "let's go", spanish: "vamos", level: "A1" },
  { english: "come with me", spanish: "ven conmigo", level: "A1" }
];
...
function globalLookup(word) {
    ...
    if (phraseMatch) {
        return {
            spanish: normalizeSpanish(phraseMatch.spanish),
            source: "CEFR Phrases",
...
if (words.length > 1) {
    ...
    return;
        ...
        /* ============================================================
           2. SPANISH → ENGLISH
        ============================================================ */
        // (Your Spanish → English block continues here)
